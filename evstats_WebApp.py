...
MAKERS = ["total", "byd", "tesla", "volvo" , "hyundai" ,  "geely", "leapmotor", "volkswagen", "bmw", "changan deepal" ]
...
def fetch_maker_metrics(time_period: str) -> pd.DataFrame:
    ...
    Output dataframe columns:
      Period, total, byd, tesla, leapmotor, geely, volkswagen, bmw, changan deepal
    Last periods:
      - month: last 18
      - quarter: last 12
      - year: last 10
